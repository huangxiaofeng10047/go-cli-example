...
func newTemplateCmd(settings *cli.EnvSettings, cfg *action.Configuration, out io.Writer, debug action.DebugLog) *cobra.Command {
	var validate bool
	...
	f := cmd.Flags()
	addInstallFlags(settings, cmd, f, client, valueOpts)
