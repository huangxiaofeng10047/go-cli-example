...
func newInstallCmd(settings *cli.EnvSettings, cfg *action.Configuration, out io.Writer, debug action.DebugLog) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		RunE: func(_ *cobra.Command, args []string) error {
			...
			rel, err := runInstall(settings, args, client, valueOpts, out, debug)
			if err != nil {
...
func runInstall(settings *cli.EnvSettings, args []string, client *action.Install, valueOpts *values.Options, out io.Writer, debug action.DebugLog) (*release.Release, error) {
